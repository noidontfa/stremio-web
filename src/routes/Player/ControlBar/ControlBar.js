...
const ControlBar = ({
  ...
  const onSubtitles2ButtonClick = React.useCallback(() => {
    if (typeof onToggleSubtitles2Menu === "function") {
      onToggleSubtitles2Menu();
    }
  }, [onToggleSubtitles2Menu]);
      ...
      <div className={styles["control-bar-buttons-container"]}>
        ...
        >
          <Button
            ...
            onClick={onStatisticsButtonClick}
          >
...
ControlBar.propTypes = {
  ...
  onToggleSubtitles2Menu: PropTypes.func,
