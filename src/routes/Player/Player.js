...
const Player = ({ urlParams, queryParams }) => {
  ...
  const [videoState, setVideoState] = React.useReducer(
    (videoState, nextVideoState) => ({ ...videoState, ...nextVideoState }),
    {
      ...
      selectedSubtitles2TrackId: null,
      ...
      selectedExtraSubtitles2TrackId: null,
      extraSubtitlesSize: null,
      extraSubtitlesDelay: null,
      extraSubtitles2Delay: null,
  ...
  const [player, timeChanged, pausedChanged, ended] = usePlayer(
    urlParams,
  ...
  const [subtitlesMenuOpen, , closeSubtitlesMenu, toggleSubtitlesMenu] =
    useBinaryState(false);
  const [subtitles2MenuOpen, , closeSubtitles2Menu, toggleSubtitles2Menu] =
    useBinaryState(false);
  ...
  const onExtraSubtitlesDelayChanged = React.useCallback((delay, subId = 1) => {
    dispatch({
      type: "setProp",
      propName: subId === 1 ? "extraSubtitlesDelay" : "extraSubtitles2Delay",
      propValue: delay,
    });
  }, []);
  ...
  React.useEffect(() => {
    if (
      ...
      if (
        ...
        videoState.duration - videoState.time <=
  ...
  return (
    ...
    >
        ...
        <div className={classnames(styles["layer"], styles["error-layer"])}>
          ...
          {player.selected !== null ? (
            <Button
              ...
              href={player.selected.stream.deepLinks.externalPlayer.href}
              download={
                player.selected.stream.deepLinks.externalPlayer.fileName
              }
              target={"_blank"}
            >
              <Icon className={styles["icon"]} name={"ic_downloads"} />
              <div className={styles["label"]}>
                {t("PLAYER_OPEN_IN_EXTERNAL")}
              </div>
            </Button>
          ) : null}
        </div>
      ...
      <ControlBar
        ...
        onToggleSubtitles2Menu={toggleSubtitles2Menu}
      ...
      {subtitlesMenuOpen ? (
        <SubtitlesMenu
          ...
          onExtraSubtitlesTrackSelected={(id) =>
            onExtraSubtitlesTrackSelected(id, 1)
          }
          ...
          onExtraSubtitlesDelayChanged={(delay) =>
            onExtraSubtitlesDelayChanged(delay, 1)
          }
      ...
      {subtitles2MenuOpen ? (
        <SubtitlesMenu
          ...
          onSubtitlesTrackSelected={onSubtitlesTrackSelected}
          onExtraSubtitlesTrackSelected={(id) =>
            onExtraSubtitlesTrackSelected(id, 2)
          }
          onAudioTrackSelected={onAudioTrackSelected}
          onSubtitlesOffsetChanged={onSubtitlesOffsetChanged}
          onSubtitlesSizeChanged={onSubtitlesSizeChanged}
          onExtraSubtitlesOffsetChanged={onSubtitlesOffsetChanged}
          onExtraSubtitlesDelayChanged={(delay) =>
            onExtraSubtitlesDelayChanged(delay, 2)
          }
          onExtraSubtitlesSizeChanged={onSubtitlesSizeChanged}
        />
      ) : null}
